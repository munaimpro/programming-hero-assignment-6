            ...
            <div className="container mx-auto">
                <footer className="footer flex flex-col lg:flex-row justify-between text-white px-10 py-30">
                    <aside className='w-3xs'>
                        <h2 className='text-3xl mb-6 font-bold'>DigiTools</h2>
                    ...
                    <nav>
                        <h6 className="capitalize font-medium text-[20px] text-white mb-4">Product</h6>
                    ...
                    <nav>
                        <h6 className="capitalize font-medium text-[20px] text-white mb-4">Company</h6>
                    ...
                    <nav>
                        <h6 className="capitalize font-medium text-[20px] text-white mb-4">Resources</h6>
                    ...
                    <nav>
                        <h6 className="capitalize font-medium text-[20px] text-white mb-4">Social Links</h6>
                        <div className='flex gap-4'>
                            <a href="#" class="btn btn-circle bg-white hover:bg-gray-200 border-none">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6">
                            ...
                            <a href="#" class="btn btn-circle bg-white hover:bg-gray-200 border-none">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="black" class="w-6 h-6">
